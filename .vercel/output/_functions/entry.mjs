...
var middlewareSecret = "7c4b0939-969c-4475-891e-8593ed75af94";
//#endregion
...
var _page0 = () => import("./chunks/generic_CuIymFuy.mjs");
var _page1 = () => import("./chunks/contact_DHN3D4iY.mjs");
...
var _manifest = deserializeManifest({"rootDir":"file:///C:/Users/ryanp/Desktop/DEV/Code%20by%20Nayru/code-by-nayru/","cacheDir":"file:///C:/Users/ryanp/Desktop/DEV/Code%20by%20Nayru/code-by-nayru/node_modules/.astro/","outDir":"file:///C:/Users/ryanp/Desktop/DEV/Code%20by%20Nayru/code-by-nayru/dist/","srcDir":"file:///C:/Users/ryanp/Desktop/DEV/Code%20by%20Nayru/code-by-nayru/src/","publicDir":"file:///C:/Users/ryanp/Desktop/DEV/Code%20by%20Nayru/code-by-nayru/public/","buildClientDir":"file:///C:/Users/ryanp/Desktop/DEV/Code%20by%20Nayru/code-by-nayru/dist/client/","buildServerDir":"file:///C:/Users/ryanp/Desktop/DEV/Code%20by%20Nayru/code-by-nayru/dist/server/","adapterName":"@astrojs/vercel","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"node_modules/astro/dist/assets/endpoint/generic.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/contact","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/contact\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"contact","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/contact.ts","pathname":"/api/contact","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/[lang]","isIndex":true,"type":"page","pattern":"^\\/([^/]+?)\\/?$","segments":[[{"content":"lang","dynamic":true,"spread":false}]],"params":["lang"],"component":"src/pages/[lang]/index.astro","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","site":"https://code-by-nayru.vercel.app","base":"/","trailingSlash":"ignore","compressHTML":true,"componentMetadata":[["C:/Users/ryanp/Desktop/DEV/Code by Nayru/code-by-nayru/src/pages/[lang]/index.astro",{"propagation":"none","containsHead":true}],["C:/Users/ryanp/Desktop/DEV/Code by Nayru/code-by-nayru/src/pages/index.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"astro/entrypoints/prerender":"prerender-entry.8AUo4Oo2.mjs","\u0000noop-middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_C-PI1Pas.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_C9j0emuM.mjs","\u0000virtual:astro:page:src/pages/[lang]/index@_@astro":"chunks/index_DymHMB0W.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","C:/Users/ryanp/Desktop/DEV/Code by Nayru/code-by-nayru/node_modules/@astrojs/react/dist/vnode-children.js":"chunks/vnode-children_B6vVcKTz.mjs","@astrojs/vercel/entrypoint":"entry.mjs","\u0000virtual:astro:page:src/pages/api/contact@_@ts":"chunks/contact_DHN3D4iY.mjs","\u0000virtual:astro:page:node_modules/astro/dist/assets/endpoint/generic@_@js":"chunks/generic_CuIymFuy.mjs","C:/Users/ryanp/Desktop/DEV/Code by Nayru/code-by-nayru/node_modules/astro/dist/assets/services/sharp.js":"chunks/sharp_X0nFMN_s.mjs","C:/Users/ryanp/Desktop/DEV/Code by Nayru/code-by-nayru/src/components/Contact.astro?astro&type=script&index=0&lang.ts":"_astro/Contact.astro_astro_type_script_index_0_lang.Dj6c4J-i.js","C:/Users/ryanp/Desktop/DEV/Code by Nayru/code-by-nayru/src/components/LocaleSwitch.astro?astro&type=script&index=0&lang.ts":"_astro/LocaleSwitch.astro_astro_type_script_index_0_lang.Bo3gz0Xy.js","@astrojs/react/client.js":"_astro/client.BLyC5uMh.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[["C:/Users/ryanp/Desktop/DEV/Code by Nayru/code-by-nayru/src/components/Contact.astro?astro&type=script&index=0&lang.ts","function e(){let e=document.querySelector(`form`),t=document.getElementById(`success-message`),n=document.getElementById(`error-message`),r=e?.querySelector(`button[type='submit']`),i=document.documentElement.lang||`fr`,a=Date.now(),o=r?.dataset.sendLabel||r?.textContent||`Envoyer le message`,s=r?.dataset.sendingLabel||`Envoi en cours...`;e&&t&&n&&r&&e.addEventListener(`submit`,async c=>{c.preventDefault(),r.disabled=!0,r.textContent=s;try{let r=new FormData(e),o={name:String(r.get(`name`)??``).trim(),email:String(r.get(`email`)??``).trim(),subject:String(r.get(`subject`)??``).trim(),message:String(r.get(`message`)??``).trim(),company:String(r.get(`company`)??``),formLoadedAt:a,locale:i},s=await fetch(`/api/contact`,{method:`POST`,headers:{\"Content-Type\":`application/json`},body:JSON.stringify(o)}),c=await s.json();s.ok?(e.reset(),t.textContent=c.message,t.classList.remove(`hidden`),n.classList.add(`hidden`)):(n.textContent=c.message||`Une erreur est survenue. Veuillez réessayer.`,n.classList.remove(`hidden`),t.classList.add(`hidden`)),setTimeout(()=>{t.classList.add(`hidden`),n.classList.add(`hidden`)},5e3)}catch{n.textContent=`Une erreur est survenue. Veuillez réessayer.`,n.classList.remove(`hidden`),t.classList.add(`hidden`),setTimeout(()=>{n.classList.add(`hidden`)},5e3)}finally{r.disabled=!1,r.textContent=o}})}e();"],["C:/Users/ryanp/Desktop/DEV/Code by Nayru/code-by-nayru/src/components/LocaleSwitch.astro?astro&type=script&index=0&lang.ts","var e=window.scrollY,t=document.getElementById(`locale-switch`),n=!0;t&&window.addEventListener(`scroll`,()=>{let r=window.scrollY;window.innerWidth<768&&(r>e&&n?(t.style.transform=`translateY(-100%)`,n=!1):r<e&&!n&&(t.style.transform=`translateY(0)`,n=!0)),e=r});"]],"assets":["/favicon.ico","/images/bg.png","/images/logo.png","/_astro/client.BLyC5uMh.js","/images/clients/logo_neat.png","/images/clients/logo_sfr.png","/images/clients/logo_spotr.png","/_astro/Footer.rnkQoquv.css","/index.html"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"FjH6drPNMU0WNK3LSQBJqvJ3BlCKYNP8DI8iChFODDc=","image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "7c4b0939-969c-4475-891e-8593ed75af94") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
